...
export const intentIqIdSubmodule = {
    ...
    getId(config) {
        ...
        let currentAbPercentage = readData(PERCENTAGE_LS_KEY + '_' + configParams.partner)
        if (currentAbPercentage !== null) currentAbPercentage = parseInt(currentAbPercentage)
        ...
        if (
            ...
            storeData(PERCENTAGE_LS_KEY + '_' + configParams.partner, configParams.abPercentage)
        ...
        url += configParams.debugIp ? '&ip=' + encodeURIComponent(configParams.debugIp) : ''
