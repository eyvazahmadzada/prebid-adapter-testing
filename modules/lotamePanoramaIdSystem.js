...
const cookiefulBrowsersListLowercase = ['chrome']
...
export const intentIqIdSubmodule = {
    ...
    decode(value, config) {
        ...
        if (
            ...
            // if (cookiefulBrowsersListLowercase.includes(currentBrowser)) {
            // }
    ...
    getId(config) {
        ...
        const currentAbPercentage = readData(PERCENTAGE_LS_KEY + '_' + configParams.partner)
